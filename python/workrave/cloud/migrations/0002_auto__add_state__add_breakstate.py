...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cloud_breakstatistics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prompted', self.gf('django.db.models.fields.IntegerField')()),
            ('taken', self.gf('django.db.models.fields.IntegerField')()),
            ('natural_taken', self.gf('django.db.models.fields.IntegerField')()),
            ('skipped', self.gf('django.db.models.fields.IntegerField')()),
            ('postponed', self.gf('django.db.models.fields.IntegerField')()),
            ('unique', self.gf('django.db.models.fields.IntegerField')()),
            ('total_overdue', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table(u'cloud_statistics', (
            ...
            ('total_active_time', self.gf('django.db.models.fields.IntegerField')()),
            ('total_click_movement', self.gf('django.db.models.fields.IntegerField')()),
            ('total_mouse_movement', self.gf('django.db.models.fields.IntegerField')()),
            ('total_movement_time', self.gf('django.db.models.fields.IntegerField')()),
            ('total_clicks', self.gf('django.db.models.fields.IntegerField')()),
            ('total_keystrokes', self.gf('django.db.models.fields.IntegerField')()),
    ...
    models = {
        ...
        u'cloud.breakstatistics': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'natural_taken': ('django.db.models.fields.IntegerField', [], {}),
            'postponed': ('django.db.models.fields.IntegerField', [], {}),
            'prompted': ('django.db.models.fields.IntegerField', [], {}),
            'skipped': ('django.db.models.fields.IntegerField', [], {}),
            'taken': ('django.db.models.fields.IntegerField', [], {}),
            'total_overdue': ('django.db.models.fields.IntegerField', [], {}),
            'unique': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'cloud.statistics': {
            ...
            'total_active_time': ('django.db.models.fields.IntegerField', [], {}),
            'total_click_movement': ('django.db.models.fields.IntegerField', [], {}),
            'total_clicks': ('django.db.models.fields.IntegerField', [], {}),
            'total_keystrokes': ('django.db.models.fields.IntegerField', [], {}),
            'total_mouse_movement': ('django.db.models.fields.IntegerField', [], {}),
            'total_movement_time': ('django.db.models.fields.IntegerField', [], {})
        },
